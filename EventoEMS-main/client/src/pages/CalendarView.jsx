      ...
      <div className=" rounded p-2">
        ...
        <div className="grid grid-cols-7 text-center">
          {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
            <div key={day} className="p-2 font-semibold bg-[#eef2ff] ring-4 ring-background">{day}</div>
          ))}
        </div>
        <div className="grid grid-cols-7 ">
          {
          emptyCells.concat(daysInMonth.map((date) => (
            <div key={date.toISOString()} className="p-2 relative top-0 pb-20 sm:pb-24 ring-4 bg-[#eef2ff] ring-background flex flex-col items-start justify-start">
