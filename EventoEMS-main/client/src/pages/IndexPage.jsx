...
import { BiLike } from "react-icons/bi";
  ...
  //! Like Functionality --------------------------------------------------------------
    ...
    return (
      <>
      <div className="mt-1 flex flex-col bg-gradient-to-r ">
        <div className="hidden sm:block" >
          <div href="#" className="flex item-center inset-0">
            <img src="../src/assets/event1.png" alt="" className='w-full h-[400px]'/> 
          </div>
        </div>
        <div className="mx-10 my-5 text-center">
          <h2 className="text-3xl font-semibold text-[#082b67]">
            Upcoming Events
          </h2>
          <p className="text-lg text-[#082b67] mt-2">
    ...
    {/* FIXME: This is a demo image after completing the create event function delete this */}
              ...
              <div className="m-2 grid gap-2">
                ...
                <div className="text-xs flex flex-col h-12 overflow-y-auto p-2 bg-gray-100 rounded-md scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">{event.description}</div>
