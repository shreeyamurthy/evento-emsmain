...
//changed from file.orginalname to unique one
...
app.post('/api/chatgpt', async (req, res) => {
   const { prompt } = req.body;
      try {
        // Make the request to OpenAI's chat completions API
        const response = await axios.post(
         'https://api.retool.com/v1/workflows/1da150fb-8c2c-4f5c-bb12-a6acee0312e7/startTrigger', // Replace with the Retool API URL
         {
           // The data or payload to send to the workflow
           data: {
             "body": prompt
           },
         },
         {
           headers: {
             'X-Workflow-Api-Key': 'retool_wk_330170bb1a7447819c5e6d90ae82b465', // Your Retool API key
...
const eventSchema = new mongoose.Schema({
   ...
   organizedBy: { type: String, require: true },
